...
"$PY" /mnt/d/Project_2025_2026_HIPPO/Workspace/03_BrainSimulator/CA1_full_scale/_wsl_build/step5g_official.py 2>&1 | grep -vE "NEST GPU|Copyright|WARRANTY|Homepage|program is provided|Calibrating|Building time|Simulation time|Simulating|Neural activity|^$"
