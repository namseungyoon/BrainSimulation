...
"$PY" /mnt/d/Project_2025_2026_HIPPO/Workspace/03_BrainSimulator/CA1_full_scale/_wsl_build/step5b_smoke_graupner.py 10 graupner 2>&1 | grep -E "weight:|rho:|RESPONDS|NO CHANGE"
