...
| **3-5** 단발 uEPSP | ✅ 진폭 1.33mV = Sayer1990 평균(0.131)의 10.2배·최대(0.665)의 2.0배 → 3-7 재보정 · 상승 1.72ms(논문 3.9±1.8)·반치폭 11.1ms(19.5±8.0) |
...
| **3-6** 확률 방출 | ✅ 방출확률 0.152 ~ Use=0.15 · 연결 실패율 0.425(이론 0.444) · CV 1.072 · **RNG 미시딩 함정 점검 통과** (4/4) |
| 3-7~3-9 · 4 · 5 · 6 · 7 | ⬜ |
