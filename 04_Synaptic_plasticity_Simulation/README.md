...
| **3-2** 시냅스 생성+가지치기 | ✅ 방사축 정렬+회전(θ*=160°)으로 인접 → 접촉 시냅스 5개 · **기하 고정**(config/geometry.yaml) — 시냅스 클래스와 무관(기하만) |
| **3-1** 시냅스 파라미터 | 🔄 **재작업** — PC→PC(Ecker2020 Table3 실측 E2)로 확정, SC→PC 삭제 ([D9](docs/DECISIONS.md)) |
| **3-3~3-6** 배선·기록·uEPSP·확률방출 | ⬜ **결과물 삭제** — 3-1 전제 오류(SC→PC 기본)로 무효. PC→PC 로 재실행 필요 |
| 3-7~3-9 · 4 · 5 · 6 · 7 | ⬜ |
