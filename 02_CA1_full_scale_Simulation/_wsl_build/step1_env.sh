...
# Run inside WSL:  bash /mnt/d/.../02_CA1_full_scale_Simulation/_wsl_build/step1_env.sh
set -euo pipefail

SRC="/mnt/d/Project_2025_2026_HIPPO/Workspace/03_BrainSimulator/02_CA1_full_scale_Simulation/"
