...
"$PY" /mnt/d/Project_2025_2026_HIPPO/Workspace/03_BrainSimulator/02_CA1_full_scale_Simulation/_wsl_build/step5c_diag.py 2>&1 | grep -vE "NEST GPU|Copyright|WARRANTY|Homepage|program is provided|^$"
