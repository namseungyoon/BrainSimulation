...
#define nrn_init _nrn_init__kdb
#define _nrn_initial _nrn_initial__kdb
#define nrn_cur _nrn_cur__kdb
#define _nrn_current _nrn_current__kdb
#define nrn_jacob _nrn_jacob__kdb
#define nrn_state _nrn_state__kdb
#define _net_receive _net_receive__kdb 
#define rates rates__kdb 
#define states states__kdb 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kdb", _hoc_setdata,
 "alpn_kdb", _hoc_alpn,
 "betn_kdb", _hoc_betn,
 "rates_kdb", _hoc_rates,
 0, 0
};
#define alpn alpn_kdb
#define betn betn_kdb
...
#define gmn gmn_kdb
 double gmn = 0.7;
#define ninf ninf_kdb
 double ninf = 0;
#define nmax nmax_kdb
 double nmax = 2;
#define q10 q10_kdb
 double q10 = 1;
#define taun taun_kdb
 double taun = 0;
#define vhalfn vhalfn_kdb
 double vhalfn = -33;
#define zetan zetan_kdb
 double zetan = 3;
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 44 in file kdb.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "kdb.mod";
static const char* nmodl_file_text = 
  "TITLE  K-D channel\n"
  ": M.Migliore jun 2006\n"
  "\n"
