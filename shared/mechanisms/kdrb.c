...
#define nrn_init _nrn_init__kdrb
#define _nrn_initial _nrn_initial__kdrb
#define nrn_cur _nrn_cur__kdrb
#define _nrn_current _nrn_current__kdrb
#define nrn_jacob _nrn_jacob__kdrb
#define nrn_state _nrn_state__kdrb
#define _net_receive _net_receive__kdrb 
#define rates rates__kdrb 
#define states states__kdrb 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kdrb", _hoc_setdata,
 "alpn_kdrb", _hoc_alpn,
 "betn_kdrb", _hoc_betn,
 "rates_kdrb", _hoc_rates,
 0, 0
};
#define alpn alpn_kdrb
#define betn betn_kdrb
...
#define gmn gmn_kdrb
 double gmn = 0.7;
#define ninf ninf_kdrb
 double ninf = 0;
#define nmax nmax_kdrb
 double nmax = 2;
#define q10 q10_kdrb
 double q10 = 1;
#define taun taun_kdrb
 double taun = 0;
#define vhalfn vhalfn_kdrb
 double vhalfn = 13;
#define zetan zetan_kdrb
 double zetan = -3;
 ...
 "vhalfn_kdrb", &vhalfn_kdrb,
 "a0n_kdrb", &a0n_kdrb,
 "zetan_kdrb", &zetan_kdrb,
 "gmn_kdrb", &gmn_kdrb,
 "nmax_kdrb", &nmax_kdrb,
 "q10_kdrb", &q10_kdrb,
 "ninf_kdrb", &ninf_kdrb,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdrb kdrb.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 46 in file kdrb.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "kdrb.mod";
static const char* nmodl_file_text = 
  "TITLE K-DR channel\n"
