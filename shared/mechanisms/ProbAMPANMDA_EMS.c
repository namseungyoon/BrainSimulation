...
#define next_delay _p[29]
#define next_delay_columnindex 29
#define A_AMPA _p[30]
#define A_AMPA_columnindex 30
#define B_AMPA _p[31]
#define B_AMPA_columnindex 31
#define A_NMDA _p[32]
#define A_NMDA_columnindex 32
#define B_NMDA _p[33]
#define B_NMDA_columnindex 33
#define factor_AMPA _p[34]
#define factor_AMPA_columnindex 34
#define factor_NMDA _p[35]
#define factor_NMDA_columnindex 35
#define mggate _p[36]
#define mggate_columnindex 36
#define usingR123 _p[37]
#define usingR123_columnindex 37
#define DA_AMPA _p[38]
#define DA_AMPA_columnindex 38
#define DB_AMPA _p[39]
#define DB_AMPA_columnindex 39
#define DA_NMDA _p[40]
#define DA_NMDA_columnindex 40
#define DB_NMDA _p[41]
#define DB_NMDA_columnindex 41
#define v _p[42]
#define v_columnindex 42
#define _g _p[43]
#define _g_columnindex 43
#define _tsav _p[44]
#define _tsav_columnindex 44
...
#endif
  hoc_register_prop_size(_mechtype, 45, 6);
...
/*VERBATIM*/
   ...
   if ( _lves > 0.0 ) {
     ...
     if ( verboseLevel > 0.0 ) {
        printf ( "[Syn %f] Release! t = %g: A_AMPA=%g weight_AMPA=%g factor_AMPA=%g" , synapseID , t , A_AMPA , _args[1] , factor_AMPA ) ;
...
static const char* nmodl_file_text = 
  ...
  "    scale_mg = 2.62     (mM)  : - Jahr & Stevens 1990 (LJP corrected)\n"
  ...
  "    init_depleted = 0          :// 0 - no depleted (old behavior)\n"
  "}\n"
  "\n"
  "COMMENT\n"
